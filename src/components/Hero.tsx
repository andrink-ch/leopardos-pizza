export default function Hero() {
  return (
    <section className="max-w-[1280px] mx-auto px-12 pt-10 pb-24 flex items-center gap-[60px]">
      {/* Left copy */}
      <div className="w-[45%] shrink-0">
        <h1 className="font-heading font-bold text-[84px] leading-[.95] tracking-[-0.025em] mt-0 mb-[26px]">
          Pizza, wo{" "}
          <span
        ...
        <p className="text-[20px] leading-[1.55] text-taupe max-w-[400px] mt-0 mb-[34px]">
        ...
        <div className="flex gap-[14px] items-center mb-[30px]">
          ...
          <a
            href="#video"
            className="no-underline px-[30px] py-[16px] rounded-[100px] text-charcoal font-semibold text-[16px] hover:bg-charcoal/5 transition-colors"
      ...
      <div id="video" className="flex-1 flex justify-center pt-[14px]">
        <div className="relative w-full max-w-[600px]" style={{ transform: "rotate(-1.6deg)" }}>
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(120% 80% at 50% 115%, #4A2310 0%, #241B15 45%, #14100D 100%)",
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(80% 100% at 50% 100%, rgba(216,84,43,.6), rgba(216,84,43,0) 70%)",
              }}
            />
            {/* Live badge */}
            <div
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-[18px]">
              ...
              <div
                className="font-mono text-[12px] tracking-[.18em]"
                style={{ color: "rgba(244,238,226,.55)" }}
              >
                [ PIZZA IM OFEN — VIDEO ]
              </div>
            </div>
